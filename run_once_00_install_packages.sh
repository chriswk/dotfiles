...
packages=("direnv" "emacs" "exa" "ripgrep" "starship" "tmux" "vim" "neovim" "xclip" "zsh" "zsh-autosuggestions" "zsh-completions" "zsh-fast-syntax-highlighting" "go" "fish" "fisher" "sxhkd" "bspwm" "autojump" "thefuck" "wmname" "rbenv" "ruby-build" "lastpass-cli" "nerd-fonts-fira-code" "nerd-fonts-hack")
